function(S_generate_vcpkg_triplet OUTPUT_VARIABLE TARGET)
    ...
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU" AND OS STREQUAL "windows")
        # Other compilers on Windows
        if(LINK_TYPE STREQUAL "dynamic")
            set(TRIPLET "${ARCH}-mingw-dynamic")
            message(NOTICE "Using community triplet: ${ARCH}-mingw-dynamic. If it causes errors, consider using MSVC or Clang instead.")
        else()
            set(TRIPLET "${ARCH}-mingw-static")
            message(NOTICE "Using community triplet: ${ARCH}-mingw-static. If it causes errors, consider switching to dynamic linking.")
        endif()
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND OS STREQUAL "windows")
        if(LINK_TYPE STREQUAL "dynamic")
            set(TRIPLET "${ARCH}-${OS}")
        else()
            set(TRIPLET "${ARCH}-${OS}-static")
